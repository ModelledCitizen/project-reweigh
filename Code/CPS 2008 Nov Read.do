*capture log close
*log using cpsnov08vnr.log, replace
set mem 500m

/*------------------------------------------------
  by Jean Roth Mon Dec  6 11:47:16 EST 2010
  Please report errors to jroth@nber.org
  NOTE:  This program is distributed under the GNU GPL. 
  See end of this file and http://www.gnu.org/licenses/ for details.
  Run with do cpsnov08vnr
...
local dat_name "Data/CPS 2008 Nov.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "Data/CPS 2008 Nov.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "Data/CPS 2008 Nov Layout.dct"
...
note: by Jean Roth, jroth@nber.org Mon Dec  6 11:47:16 EST 2010
...
label define pes3l   
	1           "Did not meet registration"               
	2           "Did not know where or how"               
	3           "Did not meet residency"                  
	4           "Permanent illness or"                    
	5           "Difficulty with English"                 
	6           "Not interested in the"                   
	7           "My vote would not make a"                
...
label define pes4l   
	1           "Illness or disability (own"              
	2           "Out of town or away from"                
	3           "Forgot to vote (or send in"              
	4           "Not interested, felt my vote"            
	5           "Too busy, conflicting work"              
	6           "Transportation problems"                 
	7           "Didn't like candidates or"               
	8           "Registration problems (i.e."             
	9           "Bad weather conditions"                  
	10          "Inconvenient hours, polling"             
	11          "Other"                                   
	-2          "Don't know"                              
	-3          "Refused"                                 
	-9          "No Response"                             
...
label define pes7l   
	1           "At a department of motor"                
	2           "At a public assistance agency"           
	3           "Registered by mail"                      
	4           "At a school, hospital, or on"            
	5           "Went to a town hall or"                  
	6           "Filled out form at a registra-"          
	7           "Registered at polling place"             
	8           "Other"                                   
	-2          "Don't know"                              
	-3          "Refused"                                 
	-9          "No Response"                             
