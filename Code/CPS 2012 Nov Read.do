*capture log close
*log using cpsnov2012.log, replace
capture set mem 500m

/*------------------------------------------------
  by Jean Roth Fri May 10 22:00:23 EDT 2013
  Please report errors to jroth@nber.org
  NOTE:  This program is distributed under the GNU GPL. 
  See end of this file and http://www.gnu.org/licenses/ for details.
  Run with do cpsnov2012
    
  Edited by David deLacoste-Azizi, 21 May 2018
----------------------------------------------- */
...
local dat_name "Data/CPS 2012 Nov.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "Data/CPS 2012 Nov.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "Data/CPS 2012 Nov Layout.dct"
...
note: by Jean Roth, jroth@nber.org Fri May 10 22:00:23 EDT 2013
...
label define peio1ocd
	...
	1240        "Mathematicians, statisticians and miscellaneous mathematical science occupations"
	1300        "Architects, except naval"                
	1310        "Surveyors, cartographers, and photogrammetrists"
	1320        "Aerospace engineers"                     
	1340        "Agricultural and biomedical engineers"   
	...
	2025        "Miscellaneous community and social service specialists, including health educators"
	2040        "Clergy"                                  
	...
	3245        "Exercise physiologists and therapists, all other"
	3250        "Veterinarians"                           
	3255        "Registered nurses"                       
	3256        "Nurse anesthetists"                      
	3258        "Nurse midwives and nurse practitioners"  
	...
	3540        "Other healthcare practitioners and technical occupations, including podiatrists"
	...
	3649        "Phlebotomists"                           
	3655        "Miscellaneous healthcare support occupations, including medical equipment"
	...
	4130        "Food preparation and serving related workers, all other including dining room and"
	4140        "Dishwashers"                             
	...
	6320        "Construction equipment operators, except Paving, surfacing, and tamping"
	6330        "Drywall installers, ceiling tile installers, and tapers"
	6355        "Electricians"                            
	6360        "Glaziers"                                
	6400        "Insulation workers"                      
	6420        "Painters, construction and maintenance and paperhangers"
	...
	6765        "Miscellaneous construction and related workers, including photovoltaic installers"
	...
	6940        "Other extraction workers, including roof bolters and helpers"
	...
	7100        "Electrical and electronics repairers, transportation equipment, industrial and utility"
	...
	7630        "Other installation, maintenance, and repair workers, including wind turbine service"
	...
	7940        "Rolling machine setters, operators, and tenders and forging machine setters,"
	...
	8550        "Miscellaneous woodworkers, including model makers and pattern makers"
	...
	8965        "Production workers, including semiconductor processors and cooling and freezing"
	...
	9240        "Railroad brake, signal, switch operators, conductors and yardmasters"
	...
	9420        "Other transportation workers, including bridge and lock tenders"
	9510        "Crane and tower operators"               
	9520        "Dredge, excavating, and loading machine operators"
	9560        "Hoist and winch operators, and conveyor operators and tenders"
	...
	9750        "Material moving workers, including mine shuttle operators and tank car, truck, and"
	9840        "Armed Forces"                            
;
...
label define pes7l   
	1           "At a department of motor vehicles (for example, when obtaining a driver's license or other"
	2           "At a public assistance agency (for example, a Medicaid, AFDC, or Food Stamps office, an"
...
label define pes8l   
	...
	-9          "No Response"                             
;
label values pusck4   pusck4l;
label define pusck4l 
	1           "Self"                                    
	2           "Other"                                   
;
